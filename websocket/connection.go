...
func newConnection(ctx *gin.Context, s *SocketServer, underlineConn UnderlineConnection, id string, uid string) *connection {
	c := &connection{
...
func (c *connection) Server() *SocketServer {
	return c.server
}
